...
;(function () {
  ...
  Modal.prototype.getPreventScrollEl = function () {
    let scrollEl = false
    let querySelector = this.element.getAttribute('data-modal-prevent-scroll')
  ...
  Modal.prototype.getFocusableElements = function () {
    ...
    let allFocusable = this.element.querySelectorAll(focusableElString)
  ...
  Modal.prototype.getFirstFocusable = function () {
    ...
    let containerIsFocusable = this.modalFocus.matches(focusableElString)
    if (containerIsFocusable) {
      this.moveFocusEl = this.modalFocus
    } else {
      this.moveFocusEl = false
      let elements = this.modalFocus.querySelectorAll(focusableElString)
      for (let i = 0; i < elements.length; i++) {
        if (isVisible(elements[i])) {
  ...
  Modal.prototype.emitModalEvents = function (eventName) {
    let event = new CustomEvent(eventName, { detail: this.selectedTrigger })
