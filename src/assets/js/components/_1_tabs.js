...
;(function () {
  ...
  Tab.prototype.selectNewTab = function (direction) {
    let selectedTab = this.tabList.querySelector('[aria-selected="true"]'),
  ...
  Tab.prototype.triggerTab = function (tabTrigger, event) {
    ...
    let index = Util.getIndexInArray(this.triggers, tabTrigger)
  ...
  function tabNavigateNext(event, layout) {
    if (
      layout == 'horizontal' &&
      ((event.keyCode && event.keyCode == 39) || (event.key && event.key == 'ArrowRight'))
    ) {
      return true
    } else if (
      layout == 'vertical' &&
      ((event.keyCode && event.keyCode == 40) || (event.key && event.key == 'ArrowDown'))
    ) {
      return true
    } else {
      return false
  ...
  function tabNavigatePrev(event, layout) {
    if (
      layout == 'horizontal' &&
      ((event.keyCode && event.keyCode == 37) || (event.key && event.key == 'ArrowLeft'))
    ) {
      return true
    } else if (
      layout == 'vertical' &&
      ((event.keyCode && event.keyCode == 38) || (event.key && event.key == 'ArrowUp'))
    ) {
      return true
    } else {
      return false
