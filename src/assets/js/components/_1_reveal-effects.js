...
;(function () {
  let fxElements = document.getElementsByClassName('reveal-fx')
  ...
  if (fxElements.length > 0) {
    ...
    let fxRevealDelta = 120 // amount (in pixel) the element needs to enter the viewport to be revealed - if not custom value (data-reveal-fx-delta)
    ...
    function fxRevealItemObserver(item) {
      let index = Util.getIndexInArray(fxElements, item)
