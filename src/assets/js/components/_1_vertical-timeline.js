...
;(function () {
  let VTimeline = function (element) {
  ...
  function initVTimeline(element) {
    ...
    for (let i = 0; i < element.sections.length; i++) {
      let observer = new IntersectionObserver(vTimelineCallback.bind(element, i), {
  ...
  let timelines = document.querySelectorAll('.js-v-timeline'),
